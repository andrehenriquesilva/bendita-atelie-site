...
⚠️ O scaffold copia a ficha-MODELO (Disney). SEMPRE preencher `dados.js` com o destino real ANTES de
renderizar — e CONFERIR na imagem exportada que aparece o destino certo (não "Disneyland Paris"). Se um
Write em `dados.js` falhar por "File has not been read yet", ler o arquivo e reescrever; senão o render
sai com o conteúdo da Disney.
